...
const createContent = (
    ...
    // 5. Cookie Consent
    base.cookieConsent.text = t.cookieText;
    base.cookieConsent.accept = t.cookieAccept;
  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: "Starter", price: "$9.99", description: "Essential tools for new stores.", features: ["1 widget", "Data analysis", "Translations", "2–5% conversion", "Design adaptation", "Email support"] },
        { name: "Grow", price: "$14.99", description: "More power for growing brands.", features: ["3 widgets", "5–10% conversion", "Design adaptation", "Email support", "Data analysis", "Translations"], recommended: true },
        { name: "Advanced", price: "$24.99", description: "Maximum performance.", features: ["3 widgets", "10% conversion", "AI Algorithm", "Live Chat", "Data analysis", "Translations"] }
      ]
    },
    faq: {
    ...
    blog: { title: "The ABU Blog", subtitle: "Insights to grow your store.", backButton: "Back to Blog", readMore: "Read Article", posts: BLOG_POSTS_EN },
    ...
    cookieConsent: { text: "We use cookies to improve your experience.", privacyLink: "Privacy Policy", accept: "Accept", decline: "Decline", customize: "Settings", modal: { title: "Cookie Settings", description: "Manage your preferences.", save: "Save", categories: [] } }
  },
  es: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: "Inicial", price: "$9.99", description: "Herramientas esenciales.", features: ["1 widget", "Análisis de datos", "Traducciones", "Diseño adaptado", "Soporte email"] },
        { name: "Crecimiento", price: "$14.99", description: "Más potencia.", features: ["3 widgets", "Diseño adaptado", "Soporte email", "Análisis", "Traducciones"], recommended: true },
        { name: "Avanzado", price: "$24.99", description: "Máximo rendimiento.", features: ["3 widgets", "Algoritmo IA", "Soporte Chat", "Análisis", "Traducciones"] }
      ]
    },
    faq: {
    ...
    blog: { title: "Blog de ABU", subtitle: "Estrategias para crecer.", backButton: "Volver", readMore: "Leer", posts: BLOG_POSTS_ES },
    ...
    cookieConsent: { text: "Usamos cookies para mejorar tu experiencia.", privacyLink: "Política de Privacidad", accept: "Aceptar", decline: "Rechazar", customize: "Configurar", modal: { title: "Preferencias", description: "Gestiona tus cookies.", save: "Guardar", categories: [] } }
  }
};
