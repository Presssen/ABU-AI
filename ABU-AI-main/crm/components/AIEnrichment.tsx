...
import { Sparkles, User, Mail, Phone, Loader2, Search, AlertCircle } from 'lucide-react';
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            if (text) {
                ...
                setResult({ ceo: "Not found", email: "Not found", phone: "Not found" });
            }
        } catch (error) {
        ...
        <GlassCard className="p-4 bg-gradient-to-br from-purple-900/10 to-blue-900/10 border-white/10">
            ...
            {loading ? (
                ...
                <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2">
                    ...
                    <button 
                        onClick={handleSearch}
                        className="w-full mt-2 text-xs text-purple-300 hover:text-white transition-colors flex items-center justify-center gap-1"
                    >
                        <Search size={10} /> Reintentar
                    </button>
                </div>
            ) : (
