...
export type Language = 
  | 'en' | 'es' | 'de' | 'cs' | 'zh-CN' | 'zh-TW' | 'ko' | 'da' | 'fi' 
  | 'fr' | 'nl' | 'it' | 'ja' | 'no' | 'pl' | 'pt-BR' | 'pt-PT' | 'sv' | 'th' | 'tr';

export type ViewState = 'landing' | 'privacy' | 'terms' | 'contact' | 'blog' | 'login' | 'dashboard' | 'demo-store' | 'demo-product' | 'demo-cart-page' | 'demo-checkout' | 'demo-post-purchase';
