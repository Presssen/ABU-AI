...
interface PrivacyPolicyProps {
  text: Content['privacyPage'];
  onBack?: () => void;
}

const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ text, onBack }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <section className="pt-40 pb-24 min-h-screen px-4">
      <SEO
        ...
        description="Read our privacy policy to understand how we collect, use, and share your information."
      />
